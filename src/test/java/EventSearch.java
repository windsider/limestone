...
public class EventSearch extends PageObject {
    ...
    public Boolean eventSearch(String eventTitle) {
        ...
        try {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.id("com.google.android.calendar:id/cancel")));

            MobileElement cancelBt = (MobileElement) driver.findElementById ("com.google.android.calendar:id/cancel");
