...
public class CalendarTests extends BaseSet {
    ...
    //@Ignore
    @Test
    public void test5_setEvent() throws NoSuchElementException {
    ...
    public void test6_searchEvent() throws NoSuchElementException {
    ...
    //@Ignore
    @Test
    public void test7_eventDisplayingWeek() throws NoSuchElementException {
    ...
    @Test
    public void test8_turnOffEvents() throws NoSuchElementException {
    ...
    //@Ignore
    @Test
    public void test2_setReminder() throws NoSuchElementException {
    ...
    //@Ignore
    @Test
    public void test3_reminderDisplayingMonth() throws NoSuchElementException {
    ...
    //@Ignore
    @Test
    public void test4_turnOffReminders() throws NoSuchElementException {
